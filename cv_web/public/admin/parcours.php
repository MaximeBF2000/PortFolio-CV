...
$prepare->execute();
$parcours_steps = $prepare->fetchAll(PDO::FETCH_ASSOC);
...
<main role="main" class="container">
  ...
  <tbody>
  <?php foreach ($parcours_steps as $parcours_step) { ?>
    <tr>
      <th scope="row"> <?= $parcours_step["id"] ?> </th>
      <td> <?= $parcours_step["icon_class"] ?> </td>
      <td> <?= $parcours_step["title"] ?> </td>
      <td> <?= $parcours_step["content"] ?> </td>
    </tr>
    <tr>
      <form action="" method="POST">
        <td></td>
        <td> <input type="text" name="icon_class" placeholder="icon_class"> </td>

...
<html lang="en">
  <head>
    ...
    <title>Maxime BOUNAAS - Login</title>
  ...
  <body class="text-center">
    <form novalidate="novalidate" class="form-signin" action="" method="POST">
  <img class="mb-4" src="./../imgBank/Maxime_Bounaas.png" alt="" width="72" height="72">

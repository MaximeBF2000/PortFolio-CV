<?php require_once(__DIR__."/../../src/Security/check_isLogged.php") ?>
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    ...
    <title>Maxime BOUNAAS - Admin</title>
...
<main role="main" class="container">
  ...
  <div class="starter-template">
    <h1>CV admin page</h1>
    <p class="lead">Use this page as a way to easily modify your cv and the data in it.<br> All you get is this text and a mostly barebones HTML document.</p>
    <img src="./../imgBank/dashboard_image.png" width=600 height=400> 
  </div>
